...
import { getAllClient } from '../../store/actions/hotkeyActions';
    ...
    render() {
        const userLinks = (
            <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                <NavLink to="/viewlist" className="btn btn-primary">See</NavLink>
                </li>
            </ul>
        );
        const guestLinks = (
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <Link to='/'><h1 className="navbar-brand">Hotkey</h1></Link>
